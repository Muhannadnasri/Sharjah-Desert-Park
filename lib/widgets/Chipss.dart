...
class ChipsInputState<T> extends State<ChipsInput<T>>
  ...
  void updateEditingValue(TextEditingValue value) {
    ...
    if (_newTextEditingValue.replacementCharactersCount >=
    ...
    if (_newTextEditingValue.text != _oldTextEditingValue.text) {
      ...
      if (_newTextEditingValue.replacementCharactersCount <
          _oldTextEditingValue.replacementCharactersCount) {
        _chips = Set.from(
            _chips.take(_newTextEditingValue.replacementCharactersCount));
      }
      _updateTextInput(putText: _value.normalCharactersText);
    }
  ...
  Widget build(BuildContext context) {
    ...
    countWidget = Text(currentCount.toString() + "/" + maxCount.toString(),
        style: countWidgetTextStyle);
